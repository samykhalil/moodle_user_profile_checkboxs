...
/**
 * Base class for unit tests for profilefield_checkboxs.
 *
...
use profilefield_checkboxs\privacy\provider;
use core_privacy\local\request\approved_userlist;

/**
 * Unit tests for user\profile\field\checkboxs\classes\privacy\provider.php
 *
 * @copyright  2018 Mihail Geshoski <mihail@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class profilefield_checkboxs_testcase extends provider_testcase {
    ...
    public function test_get_contexts_for_userid() {
        ...
        $profilefieldid = $this->add_profile_field($categoryid, 'checkboxs');
        // Create a user.
    ...
    public function test_export_user_data() {
        // Create profile category.
        $categoryid = $this->add_profile_category();
        // Create checkboxs profile field.
        $checkboxprofilefieldid = $this->add_profile_field($categoryid, 'checkboxs');
        // Create datetime profile field.
        $datetimeprofilefieldid = $this->add_profile_field($categoryid, 'datetime');
        // Create a user.
        $user = $this->getDataGenerator()->create_user();
        $context = context_user::instance($user->id);
        // Add checkboxs user info data.
        ...
        $this->export_context_data_for_user($user->id, $context, 'profilefield_checkboxs');
        $data = $writer->get_data([get_string('pluginname', 'profilefield_checkboxs')]);
    ...
    public function test_delete_data_for_user() {
        ...
        $userinfodata = $DB->get_records('user_info_data', ['userid' => $user->id]);
        $this->assertCount(2, $userinfodata);
        $approvedlist = new \core_privacy\local\request\approved_contextlist($user, 'profilefield_checkboxs',
            [$context->id]);
    ...
    public function test_get_users_in_context() {
        ...
        $component = 'profilefield_checkboxs';
        // Create profile category.
        $categoryid = $this->add_profile_category();
        // Create profile field.
        $profilefieldid = $this->add_profile_field($categoryid, 'checkboxs');
